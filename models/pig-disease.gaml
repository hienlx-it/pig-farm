...
species PigDisease parent: Pig {
	...
	list<string> pig_images<- ['', '-yellow', '-red', '-green'];
	...
	aspect base {
		draw image("../includes/images/pig"+pig_images[seir]+".png") size: (2 + weight/50) with_precision 2;
